...
static void send_dtmf(int dtmf) {
	char* cmd = NULL;
	switch (dtmf) {
	case '0': cmd = "sudo /home/pi/1414/phone/set-dtmf0"; break;
	case '1': cmd = "sudo /home/pi/1414/phone/set-dtmf1"; break;
	case '2': cmd = "sudo /home/pi/1414/phone/set-dtmf2"; break;
	case '3': cmd = "sudo /home/pi/1414/phone/set-dtmf3"; break;
	case '4': cmd = "sudo /home/pi/1414/phone/set-dtmf4"; break;
	case '5': cmd = "sudo /home/pi/1414/phone/set-dtmf5"; break;
	case '6': cmd = "sudo /home/pi/1414/phone/set-dtmf6"; break;
	case '7': cmd = "sudo /home/pi/1414/phone/set-dtmf7"; break;
	case '8': cmd = "sudo /home/pi/1414/phone/set-dtmf8"; break;
	case '9': cmd = "sudo /home/pi/1414/phone/set-dtmf9"; break;
	default : return;
	}
	system(cmd);
}
