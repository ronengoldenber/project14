<?php
	function checkxvmark($val) {
		if($val == 'X') {
			return '<img src="http://mobile.1414intl.com/1414/images/markx.png"/>';
		}
		if($val == 'V') {
			return '<img src="http://mobile.1414intl.com/1414/images/vmark.png"/>';
		}
		return $val;
	}
	function planline($col1, $col2, $col3, $col4) {
		...
		echo '<td align=center style="border-bottom: 1px solid ' . $color .'; padding:2px; font-size:14px; color: black;">' . $col2 . '</td>' . PHP_EOL;
		echo '<td style="border-bottom: 1px solid ' . $color . ';">&nbsp;</td>' . PHP_EOL;
		echo '<td align=center style="border-bottom: 1px solid ' . $color . '; padding:2px; font-size:14px; color:black;">' . $col3 . '</td>' . PHP_EOL;
		echo '<td style="border-bottom: 1px solid ' . $color . ';">&nbsp;</td>' . PHP_EOL;
		echo '<td align=center style="border-bottom: 1px solid ' . $color . '; padding:2px; font-size:14px; color:black;">' . $col4 . '</td>' . PHP_EOL;
		echo '</tr>' . PHP_EOL;
		return 0;
	}
	function plans() {
		...
		echo '<div style="font-size:28px;" align=center><font color=black>Plans</font></div>' . PHP_EOL;
		...
		echo '</tr>' . PHP_EOL;
		planline('','','','');
		planline('Price after month', '$1.98', '$2.98', '$3.98');
		planline('Unlimited incoming', 'V', 'X', 'V');
		planline('Unlimited calls', 'X', 'V', 'V');
		planline('Caller ID' ,'X', 'X', 'V'); 
		planline('Local number' , 'V', 'X', 'V');
	...
	function groups() {
		echo '<div class="inner">' . PHP_EOL;
		echo '<div id="bardiv"><br><br>' . PHP_EOL;
		echo '<div style="font-size:28px;" align=center><font color=black>Demo</font></div>' . PHP_EOL;
		echo '<br><br></div>' . PHP_EOL;
		echo '<div align=center>' . PHP_EOL;
	...
	function how_does_it_work_get_text($id, $type) {
		...
		$o2a = $o2a .	'<font color=black>&nbsp;Pair the phone and the device with bluetooth</font><br>';
		$o2b = '<font color=black>Purchase a device for $49.89. Connect the device to your modem. Pair the phone with bluetooth';

		$o3a = 			'<br><font color=black>&nbsp;Send The Device To Your Family</font>';
		$o3a = $o3a .	'<br><font color=black>&nbsp;Or we will send it for standard shipping rates</font>';
		$o3b = '<font color=black>Send The Device To Your Family or we will send it for standard shipping rates</font>';

		$o4a =			'<br><font color=black>&nbsp;Buy a mobile phone plan in your Country</font>';
		$o4a = $o4a .	'<br><font color=black>&nbsp;Unlimited talk and text from your old phone</font>';
		$o4a = $o4a .	'<br><font color=black>&nbsp;Or buy a 2G phone for only $24.98</font>';
		$o4b = '<font color=black>Buy a mobile phone plan in your Country. Use your old phone or buy a 2G phone for only $24.98</font>';
		if($id == '1' && $type == 'a') return $o1a;
		if($id == '1' && $type == 'b') return $o1b;
		if($id == '2' && $type == 'a') return $o2a;
		if($id == '2' && $type == 'b') return $o2b;
		if($id == '3' && $type == 'a') return $o3a;
		if($id == '3' && $type == 'b') return $o3b;
		if($id == '4' && $type == 'a') return $o4a;
		if($id == '4' && $type == 'b') return $o4b;
		return 0;
	}
	function how_does_it_work_js() {
		echo '<script>' . PHP_EOL;
		echo 'function screenSize() {' . PHP_EOL;
		...
		echo '	if(width > 600) {' . PHP_EOL;
		for($i = 1; $i <= 4; $i++) { 
			echo '	document.getElementById("div_mobile_oval' . $i . '").innerHTML = "' . how_does_it_work_get_text($i, 'b') . '";' . PHP_EOL;
			echo '	document.getElementById("div_mobile_oval' . $i . '").style.height = "24px";' . PHP_EOL;
			echo '	document.getElementById("div_mobile_oval' . $i . '").setAttribute("align", "center");' . PHP_EOL;
		}
		echo '	}' . PHP_EOL;
		echo '	if(width < 600) {' . PHP_EOL;
		for($i = 1; $i <= 4; $i++) {
			echo '	document.getElementById("div_mobile_oval' . $i . '").innerHTML = "' . how_does_it_work_get_text($i, 'a') . '";' . PHP_EOL;
			echo '	document.getElementById("div_mobile_oval' . $i . '").style.height = "74px";' . PHP_EOL;
			echo '	document.getElementById("div_mobile_oval' . $i . '").setAttribute("align", "left");' . PHP_EOL;
		}
		echo '	}' . PHP_EOL;
		echo '}' . PHP_EOL;
		echo 'screenSize();'. PHP_EOL;
		echo '</script>' . PHP_EOL;
		return 0;
	}
	function how_does_it_work() {
		...
		echo '<div id="bardiv"><br><br>' . PHP_EOL;
		echo '<div style="font-size:28px;" align=center><font color=black>How Does It Work</font></div>' . PHP_EOL;
		echo '<br><br></div>' . PHP_EOL;
		echo '<div align=center style="padding:10px;">' . PHP_EOL;
		echo '<br><div align=left id="div_mobile_oval1" name="div_mobile_oval1" style="font-size:14px;">' . PHP_EOL;
		echo '</div><br>' . PHP_EOL;
		echo '<div align=left id="div_mobile_oval2" name="div_mobile_oval2" style="font-size:14px;">' . PHP_EOL;
		echo '</div><br>' . PHP_EOL;
		echo '<div align=left id="div_mobile_oval3" name="div_mobile_oval3" style="font-size:14px;">' . PHP_EOL;
		echo '</div><br>' . PHP_EOL;
		echo '<div align=left id="div_mobile_oval4" name="div_mobile_oval4" style="font-size:14px;">' . PHP_EOL;
...
<script src="http://mobile.1414intl.com/1414/script/jquery-1.6.js"></script>
<!--<script src="script/jquery-2.1.1.js"></script>-->
<!--<script src="script/jquery-1.11.1.js"></script>-->
<script src="http://mobile.1414intl.com/1414/script/jquery.scrollify.js"></script>
<script src="http://mobile.1414intl.com/1414/script/main.js"></script>
