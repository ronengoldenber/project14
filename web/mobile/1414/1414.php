...
function html_field($title, $title_font_size, $field, $input, $nbsp) {
...
function js_check_password($form) {
    ...
    echo '	div.innerHTML = "<font size=2>&nbsp;</font>";' . PHP_EOL;
	echo '	if(color == "red") {' . PHP_EOL;
	echo '		div.innerHTML = "<font size=2 color=red><b>Password must contains digit,<br> lowercase, uppercase, special symbols,<br> length between 6 and 20</b></font>";' . PHP_EOL;
	echo '	}' . PHP_EOL;
...
function html_tos_pp() {
	echo '<div id="subdiv"><font size=1 color=black> By clicking Join now<br>You agree to 1414\'s <a href=http://1414intl.com/terms>Terms and Conditions</a> and <a href=http://1414intl.com/privacy>Privacy Policy</a></font></div>' . PHP_EOL;
	return true;
}
