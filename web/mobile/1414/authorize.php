<?php
	...
	function main_screen($fname, $lname, $email, $password) {
		...
		echo '<div><a href="http://1414intl.com/"><img src="http://1414intl.com/1414/images/1414BigIconPrecise.png" alt="1414"></a></div>' . PHP_EOL;
	...
	function send_email_to_user($fname, $lname, $email, $url) {
		...
		$body .= '<font size=3 color=black>Enjoy unlimited long distance calls<br> landline or mobile</font><br>' . PHP_EOL;
		...
		$body .= '<font size=2 color=black> By clicking Activate,' . PHP_EOL;
		$body .= 'you agree to 1414\'s <a href=http://1414intl.com/terms>Terms and Conditions</a> and <a href=http://1414intl.com/privacy>Privacy Policy</a>' . PHP_EOL;
