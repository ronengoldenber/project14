...
//        [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent];
        ...
        [UIView animateWithDuration:0.3f
                         animations:^{statusBarBG.backgroundColor =
                             [UIColor colorWithRed:((float)((0xE2E2E2 & 0xFF0000) >> 16))/255.0 \
                                             green:((float)((0xE2E2E2 & 0x00FF00) >>  8))/255.0 \
                                              blue:((float)((0xE2E2E2 & 0x0000FF) >>  0))/255.0 \
                                            alpha:1.0];} ];
    } else  {
