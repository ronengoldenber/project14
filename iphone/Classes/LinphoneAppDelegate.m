...
1414*/
/*1414- (UIUserNotificationCategory*)getCallNotificationCategory {
...
/*	NSDictionary *remoteNotif =[launchOptions objectForKey:UIApplicationLaunchOptionsRemoteNotificationKey];
    ...
    //1414
//    [TestFairy begin:@"f7aca79c9339d1883ccddc0345dcf472b2690561"];
...
1414*/
/*1414- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo {
...
/*1414- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo fetchCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler
{
    LOGI(@"%@ : %@", NSStringFromSelector(_cmd), userInfo);
