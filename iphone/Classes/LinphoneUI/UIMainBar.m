...
//1414    [_backgroundButton release];
...
- (void) setButtonLocation {
  ...
  //  int width = [ [ UIScreen mainScreen ] bounds ].size.width;
    int c1 = 0, c2 = 0, c3 = 0, c4 = 0, c5 = 0, h = 0, w = 0, space = 0;
    // iphone 4 (heigth = 480, width = 320)
    if(height < 568) {
        w = 64;
        h = 51;
        space = (320  - (w * 5)) / 4;
        c1 = 0 + 64 / 2; c2 = c1 + w + space; c3 = c2 + w + space; c4 = c3 + w + space; c5 = 320 - 64 / 2;
    }
    ...
    if(height >= 667 && height < 736) {
        ...
        h = 51;
        space = (375  - (w * 5)) / 4;
        c1 = 0 + 64 / 2; c2 = c1 + w + space; c3 = c2 + w + space; c4 = c3 + w + space; c5 = 375 - 64 / 2;
    }
    ...
    if(height >= 736) {
        ...
        h = 51;
        space = (414  - (w * 5)) / 4;
        c1 = 0 + 64 / 2; c2 = c1 + w + space; c3 = c2 + w + space; c4 = c3 + w + space; c5 = 414 - 64 / 2;
    }
    historyButton.center = CGPointMake(c1, 25);
    contactsButton.center = CGPointMake(c2, 25);
    dialerButton.center = CGPointMake(c3, 25);
    chatButton.center = CGPointMake(c4, 25);
    settingsButton.center = CGPointMake(c5, 25);
}
...
- (void)viewDidLoad {
    ...
    [dialerButton setContentHorizontalAlignment:UIControlContentHorizontalAlignmentCenter];
    [dialerButton setContentVerticalAlignment:UIControlContentVerticalAlignmentBottom];
